    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          <Route
            path="/MeusFretes/MonitoramentoEViagens"
            element={<MonitoramentoEViagens />}
          />

          {/* Rotas para Buscar Fretes */}
          <Route
            path="/BuscarFretes/CotacaoFretes"
            element={<CotacaoFretes />}
          />
          ...
          <Route
            path="/GerenciamentoRiscos/CadastroConsulta"
          ...
          <Route
            path="/Relatorios/AvaliacaoDaEmpresa"
            element={<AvaliacaoDaEmpresa />}
          />
          <Route
            path="/Relatorios/DadosDosFretes"
            element={<DadosDosFretes />}
          />

          {/* Rotas para Minha Conta */}
          <Route
            path="/MinhaConta/ConsumoDeProdutos"
            element={<ConsumoDeProdutos />}
          />
          <Route
            path="/MinhaConta/GestaoDeAcessos"
            element={<GestaoDeAcessos />}
          />
          <Route
            path="/MinhaConta/IdentificacaoDePagamentos"
            element={<IdentificacaoDePagamentos />}
          />
